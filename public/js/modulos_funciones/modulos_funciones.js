...
function nuevoModulo() {
    ...
    .fail(function (jqXHR,state,error) {
        abrirAlerta("alertas-nuevo-modulo","danger",JSON.parse(jqXHR.responseText).errors,null,"modal-nuevo-modulo");
        cerrarBlockUiCargando();
    })
}
...
function nuevaFuncion() {
    ...
    .fail(function (jqXHR,state,error) {
        abrirAlerta("alertas-nueva-funcion","danger",JSON.parse(jqXHR.responseText).errors,null,"modal-nueva-funcion");
        cerrarBlockUiCargando();
    })
}
...
function cargarFormEditar(){
    ...
    $.post(url,params)
        ...
        .fail(function (jqXHR,state,error) {
            //abrirAlerta("alertas-nuevo-rol","danger",JSON.parse(jqXHR.responseText).errors,null,"modal-nuevo-rol");
...
function editarModulo() {
    ...
    $.post(url,params)
        ...
        .fail(function (jqXHR,state,error) {
            abrirAlerta("alertas-editar-modulo","danger",JSON.parse(jqXHR.responseText).errors,null,"modal-editar-modulo");
            cerrarBlockUiCargando();
        })
}
...
function editarFuncion() {
    ...
    $.post(url,params)
        ...
        .fail(function (jqXHR,state,error) {
            abrirAlerta("alertas-editar-funcion","danger",JSON.parse(jqXHR.responseText).errors,null,"modal-editar-modulo");
            cerrarBlockUiCargando();
        })
}