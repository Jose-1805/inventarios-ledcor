...
use InventariosLedcor\Http\Requests\RequestFuncion;
use InventariosLedcor\Http\Requests\RequestModulo;
use InventariosLedcor\Models\Funcion;
use InventariosLedcor\Models\Modulo;
...
class ModulosFuncionesController extends Controller
{
    ...
    {
        $this->middleware('permisoModulo:1,' . $this->privilegio_superadministrador);
    }
    ...
    {
        if (!Auth::user()->tieneFuncion(1, 2, $this->privilegio_superadministrador))
    ...
    {
        if (!Auth::user()->tieneFuncion(1, 1, $this->privilegio_superadministrador))
            return response(['error' => ['Unauthorized.']], 401);
